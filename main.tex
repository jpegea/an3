...
\begin{figure}[hbtp]
  ...
  \begin{tikzpicture}
    ...
    \draw[red,dashed,very thick] (0,\b) rectangle (\a,0);
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[scale=.9]
    \draw[thick,->] (-1.5,0) -- (1.5,0);
    \draw[thick,->] (0,-1.5) -- (0,1.5);
    \draw[OliveGreen, very thick] (-0.75,0) -- (0,0.75) -- (0.75,0) -- (0,-0.75) -- cycle;

    \draw[thick,->] (3,0) -- (6,0);
    \draw[thick,->] (4.5,-1.5) -- (4.5,1.5);
    \draw[RedViolet, very thick] (4.5,0) circle(0.75);

    \draw[thick,->] (7.5,0) -- (10.5,0);
    \draw[thick,->] (9,-1.5) -- (9,1.5);
    \draw[OliveGreen, very thick] (7.75,0) -- (9,1.25) -- (10.25,0) -- (9,-1.25) -- cycle;
    \draw[RedViolet, very thick] (9,0) circle(0.75);
    \draw[OliveGreen, very thick] (8.4,0) -- (9,0.6) -- (9.6,0) -- (9,-0.6) -- cycle;
  \end{tikzpicture}
